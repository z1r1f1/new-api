...
func clonePlaygroundContextKeys(c *gin.Context) map[any]any {
...
func runPlaygroundImageTask(taskID, requestURI string, headers http.Header, body []byte, keys map[any]any) {
	defer func() {
		if r := recover(); r != nil {
