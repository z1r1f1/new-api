...
func (a *Adaptor) DoHTTPToWebsocketRequest(c *gin.Context, info *relaycommon.RelayInfo, requestBody io.Reader) (*http.Response, error) {
	return channel.DoHTTPToWebsocketRequest(a, c, info, requestBody)
}
