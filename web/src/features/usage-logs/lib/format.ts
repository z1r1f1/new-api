...
/**
 * Return the human-readable origin of a channel-affinity key without
 * exposing the complete secret. The cache-stats dialog uses this as a label
 * for the key hint/fingerprint supplied by the backend.
 */
