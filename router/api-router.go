...
func SetApiRouter(router *gin.Engine) {
	...
	{
		SetChatRouter(router, apiRouter)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/linuxdo-credit/notify", controller.LinuxDoCreditNotify)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/test/batch", controller.TestChannelsBatch)
			...
			channelRoute.POST("/:id/codex/redo_oauth", controller.RedoChannelAutoTeamOAuth)
			channelRoute.POST("/:id/chatgpt/redo", controller.RedoChannelAutoTeamOAuth)
